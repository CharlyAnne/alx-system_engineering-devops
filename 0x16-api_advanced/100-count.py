...
def recurse(subreddit, top_list=[]):
    """
    Function returns list of title of the top posts in a subreddit.
    """
    def recurse_post(lsr, post_list, curr_idx):
        """function recursively add all title to top_list."""
    ...
    def get_post(limit, after, url, header, post_list):
        """
        function recursively make request to reddit api(Handled its
        pagination).
        """
